                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Id Pasajero</th><th>Nombres Pasajero</th><th>Apellidos Pasajero</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($usuarios as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->id_pasajero }}</td><td>{{ $item->nombres_pasajero }}</td><td>{{ $item->apellidos_pasajero }}</td>
                                        <td>

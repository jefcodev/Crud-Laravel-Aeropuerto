                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Id Pasajero </th><td> {{ $usuario->id_pasajero }} </td></tr><tr><th> Nombres Pasajero </th><td> {{ $usuario->nombres_pasajero }} </td></tr><tr><th> Apellidos Pasajero </th><td> {{ $usuario->apellidos_pasajero }} </td></tr>
                                </tbody>
                            </table>
                        </div>

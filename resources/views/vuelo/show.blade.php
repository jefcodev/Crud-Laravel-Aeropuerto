                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $vuelo->id }}</td>
                                    </tr>
                                    <tr><th> Codigo Vuelo </th><td> {{ $vuelo->codigo_vuelo }} </td></tr><tr><th> Plazas Vacias </th><td> {{ $vuelo->plazas_vacias }} </td></tr><tr><th> Plazas Ocupadas </th><td> {{ $vuelo->plazas_ocupadas }} </td></tr>
                                </tbody>
                            </table>
                        </div>

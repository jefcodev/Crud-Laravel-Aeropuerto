                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Codigo Aeropuerto</th><th>Nombre Aeropuerto</th><th>Ciudad Aeropuerto</th>
                                        <th>Pais Aeropuerto</th><th>Hora Despegue</th><th>Hora Aterizaje</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($aeropuerto as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->codigo_aeropuerto }}</td><td>{{ $item->nombre_aeropuerto }}</td><td>{{ $item->ciudad_aeropuerto }}</td>
                                        <td>{{ $item->pais_aeropuerto }}</td>
                                        <td>{{ $item->hora_despegue }}</td>
                                        <td>{{ $item->hora_aterrizaje }}</td>
                                        <td>
                                            <a href="{{ url('/aeropuerto/' . $item->id) }}" title="View aeropuerto"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
